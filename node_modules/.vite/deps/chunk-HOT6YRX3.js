...
.p-tabview-tablist {
    ...
    flex: 1 1 auto;
    background: ${n("tabview.tab.list.background")};
    border: 1px solid ${n("tabview.tab.list.border.color")};
...
.p-tabview-tab-header {
    ...
    border-style: solid;
    border-width: 0 0 1px 0;
    border-color: transparent transparent ${n("tabview.tab.border.color")} transparent;
    color: ${n("tabview.tab.color")};
    padding: 1rem 1.125rem;
    font-weight: 600;
    border-top-right-radius: ${n("border.radius.md")};
    border-top-left-radius: ${n("border.radius.md")};
    transition: color ${n("tabview.transition.duration")}, outline-color ${n("tabview.transition.duration")};
    margin: 0 0 -1px 0;
    outline-color: transparent;
}

.p-tabview-tablist-item:not(.p-disabled) .p-tabview-tab-header:focus-visible {
    outline: ${n("focus.ring.width")} ${n("focus.ring.style")} ${n("focus.ring.color")};
    outline-offset: -1px;
}

.p-tabview-tablist-item:not(.p-highlight):not(.p-disabled):hover > .p-tabview-tab-header {
    color: ${n("tabview.tab.hover.color")};
}

.p-tabview-tablist-item.p-highlight > .p-tabview-tab-header {
    color: ${n("tabview.tab.active.color")};
}
...
.p-tabview-prev-button {
    ...
    background: ${n("tabview.nav.button.background")};
    color: ${n("tabview.nav.button.color")};
    width: 2.5rem;
    border-radius: 0;
    outline-color: transparent;
    transition: color ${n("tabview.transition.duration")}, outline-color ${n("tabview.transition.duration")};
    box-shadow: ${n("tabview.nav.button.shadow")};
    border: none;
    cursor: pointer;
    user-select: none;
}
...
.p-tabview-prev-button:hover {
    color: ${n("tabview.nav.button.hover.color")};
}
...
.p-tabview-panels {
    background: ${n("tabview.tab.panel.background")};
    color: ${n("tabview.tab.panel.color")};
...
.p-tabview-ink-bar {
    ...
    bottom: -1px;
    height: 1px;
    background: ${n("tabview.tab.active.border.color")};
...
//# sourceMappingURL=chunk-HOT6YRX3.js.map
