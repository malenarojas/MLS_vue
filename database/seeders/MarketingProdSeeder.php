...
class MarketingProdSeeder extends Seeder
{
    /**
    ...
    {
        // Crear o actualizar el módulo Marketing
        $module = Module::updateOrCreate([
            'name' => 'Marketing RE/MAX'
        ], [
            'image' => '/intranet/marketing.jpg'
        ]);

        // Crear página principal de Marketing
        $page = Page::updateOrCreate([
            'title' => 'Marketing RE/MAX',
            'module_id' => $module->id,
        ], [
            'image' => '/intranet/marketing.jpg',
        ]);
        ...
        // Definir las secciones y elementos basados en el HTML
        $secciones = [
            'BRANDING' => [
            ...
            'MANUAL DE MARCA' => [
                ['type' => 'link', 'name' => 'MANUAL DE MARCA 2024', 'url' => 'https://drive.google.com/file/d/1uk9gl8eCTXJ4rzqWNu4SkW47MH2jVbmb/view?usp=drive_link'],
                ['type' => 'link', 'name' => 'MANUAL DE MARCA 2023 TEAM.pdf', 'url' => 'https://drive.google.com/file/d/1mw-dz0Xm2PMBRHtmiXGzrd2C3BPaicjE/view?usp=drive_link'],
                ['type' => 'link', 'name' => 'MANUAL DE MARCA 2022 - LETREROS REMAX CON QR.pdf', 'url' => 'https://drive.google.com/file/d/18ukGe0dZ06cfgSaebbSUxdb-yDDro2Yp/view?usp=drive_link'],
            ],
            'REDES SOCIALES' => [
            ...
            'TIK TOK' => [
                ['type' => 'link', 'name' => 'Reclutamiento', 'url' => 'https://drive.google.com/drive/folders/1JOY409Ht27GJuSIFuHLbEWPj_22ELq3t?usp=sharing'],
                ['type' => 'link', 'name' => 'Franquicias', 'url' => 'https://drive.google.com/drive/folders/1OadRgA3lHWKpaqDsLMpq3G4YFqobBdcT?usp=sharing'],
