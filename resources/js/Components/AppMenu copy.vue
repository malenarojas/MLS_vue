<template>
    <aside
        class="absolute shadow-xl left-0 top-0 z-[51] flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark: lg:static lg:translate-x-0"
        :class="{
    ...
    >
        ...
        >
            ...
            <button class="block lg:hidden" @click="isOpenMenu = false">
                <svg
                    class="fill-current"
                    width="20"
                    height="18"
        ...
        >
            ...
            >
                <PanelMenu
                    ...
                    class="w-full bg-white rounded-xl dark:"
                >
                    <template #item="{ item }">
                        <!-- <Link
                        ...
                        <a
                            v-else
                            v-ripple
                            class="flex items-center cursor-pointer text-surface-700 dark: px-4 py-2"
                            :target="item.target"
                        >
                            <span :class="item.icon" />
                            <span class="ml-2">{{ item.label }}</span>
