...
class StoreAgentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'date_termination' =>'nullable|string|max:255',
            'studies' => 'nullable|string|max:255',
            'agent_status_id'=>'nullable|numeric',
            'additional_education' => 'nullable|string|max:255',
            'image_agent' => [
            'nullable',
            'string',
            'regex:/^data:image\/(jpeg|png|jpg|gif);base64,/',],
            'image_name' => 'nullable|string|max:255',
            'previous_occupation' => 'nullable|string|max:255',
            'license_type' => 'nullable|string|max:255',
            'license_department' => 'nullable|string|max:255',
            'year_obtained_license' => 'nullable|string|max:255',
            'expiration_date_license' => 'nullable|string|max:255',
            ...
            'archivo.*' => 'nullable|file|mimes:pdf,jpeg,png,jpg,gif', // 🎯 Asegura que sean archivos válidos
            'descriptions' => 'nullable|array',
            'descriptions.*' => 'nullable|string|max:255',
            'types' => 'nullable|array',
            'types.*' => 'nullable|exists:documentation_types,id',
        ];
    }
     /**
